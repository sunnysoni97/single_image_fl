...
def create_dataloader(
    ...
    kwargs = {"num_workers": workers, "pin_memory": True, "drop_last": False, "shuffle":shuffle_var}
...
def combine_val_loaders(dataset_name:str, path_to_data:str, n_clients:int, batch_size: int, workers: int):
    ...
    dataset = TorchVision_FL(data=val_data,targets=val_targets,transform=transformF)

    kwargs = {"num_workers":workers, "batch_size":batch_size,"pin_memory":True,"drop_last":False}
