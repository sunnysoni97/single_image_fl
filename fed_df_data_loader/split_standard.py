...
def create_std_distill_loader(dataset_name: str, storage_path: Path, n_images: int, alpha: float = 1000.0, batch_size: int = 32, n_workers: int = 0, seed: int = None) -> DataLoader:
